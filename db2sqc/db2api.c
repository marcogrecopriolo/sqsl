...
#define yyparse         db2apiparse
#define yylex           db2apilex
#define yyerror         db2apierror
#define yylval          db2apilval
#define yychar          db2apichar
#define yydebug         db2apidebug
#define yynerrs         db2apinerrs
...
extern YYSTYPE db2apilval;

#ifdef YYPARSE_PARAM
#if defined __STDC__ || defined __cplusplus
int db2apiparse (void *YYPARSE_PARAM);
#else
int db2apiparse ();
#endif
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int db2apiparse (void);
#else
int db2apiparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
{
      21,     0,    -1,     4,    22,    -1,     3,    23,    -1,    -1,
       8,     7,     5,    -1,     8,     6,     5,    -1,    19,    18,
      17,    24,    -1,    19,    12,    -1,    11,    25,    -1,    10,
      25,    -1,    12,    -1,    16,    -1,    15,    -1,    14,    -1,
      13,    -1,    -1,     9,    -1
};
...
{
       0,    90,    90,    93,    96,    98,   100,   104,   106,   109,
     112,   115,   119,   122,   125,   128,   132,   134
};
#endif
...
{
  "$end", "error", "$undefined", "API", "CONNECT", "MODE", "EXCLUSIVE",
  "SHARE", "IN", "WORK", "ROLLBACK", "COMMIT", "SQLTOK", "RS", "RR", "CS",
  "UR", "TO", "ISOLATION", "CHANGE", "$accept", "target", "connect", "api",
  "iso", "work", YY_NULL
};
#endif
...
{
       0,     0,     4,     0,    16,    16,    11,     0,     3,     0,
       2,     1,    17,    10,     9,     8,     0,     0,     0,     0,
       6,     5,    15,    14,    13,    12,     7
};
...
{
       2,   -10,    -5,    15,     7,     7,   -11,    -8,   -11,     1,
     -11,   -11,   -11,   -11,   -11,   -11,     0,    13,    14,    -2,
...
{
       4,     5,     6,     9,    15,     1,     2,    17,    18,     7,
      16,    22,    23,    24,    25,    11,    12,    19,    20,    21,
       0,    14
};
...
{
      10,    11,    12,     8,    12,     3,     4,     6,     7,    19,
      18,    13,    14,    15,    16,     0,     9,    17,     5,     5,
      -1,     5
};
...
{
       0,     3,     4,    21,    10,    11,    12,    19,    23,     8,
      22,     0,     9,    25,    25,    12,    18,     6,     7,    17,
       5,     5,    13,    14,    15,    16,    24
};
